...
export default function Hero() {
  ...
  <div class="block p-6 mt-20 rounded-lg shadow-lg max-w-5xl">
    ...
    <div className="flex justify-center mt-20 gap-x-5 md:w-9/12 w-full">
    ...
    <button style={{background:"#f9fe73"}} className="h-min text-grey-100 gap-x-2 font-bold  text-lg px-10 py-5 rounded-3xl shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 hover:bg-hotpink" type="button">LearnMore </button>
